...
- Parent roadmap: specs/user-administration/user-identity-update/roadmap.md
- Absorbed scope: the self-service half of "Update User Identity From the Web Workbench", a frontend-only slice split between GH-24 and GH-25 on 2026-09-10 and deleted from GitHub.
