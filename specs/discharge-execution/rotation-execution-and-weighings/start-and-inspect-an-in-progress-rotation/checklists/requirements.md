# Requirements Checklist: Start and Inspect an In Progress Rotation
...
- [ ] Define the actor, scope, intended behavior, and observable acceptance criteria for "Start and Inspect an In Progress Rotation" before planning.
