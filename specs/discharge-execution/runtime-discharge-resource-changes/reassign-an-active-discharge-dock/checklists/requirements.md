# Requirements Checklist: Reassign an Active Discharge Dock
...
- [ ] Define the actor, scope, intended behavior, and observable acceptance criteria for "Reassign an Active Discharge Dock" before planning.
