...
- Parent roadmap: specs/discharge-execution/runtime-discharge-resource-changes/roadmap.md
- Absorbed scope: the truck pool part of "Discharge Detail: Dock Reassignment, Truck Pool, and Door Assignment Changes", a frontend-only slice split between GH-75, GH-76 and GH-77 on 2026-09-10 and closed on GitHub.
