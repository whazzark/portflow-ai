...
- [ ] T037 [VERIFY] [DOC] Perform the manual SC-004 timed workbench review described in `specs/site-references/customer-reference-and-site-reference-lifecycle-foundation/administer-customers-from-the-web-workbench/quickstart.md`, recording whether a known customer can be opened and a lifecycle action begun within 60 seconds.
- [ ] T038 [VERIFY] [DOC] Perform the manual SC-005 mutation-refresh timing review described in `specs/site-references/customer-reference-and-site-reference-lifecycle-foundation/administer-customers-from-the-web-workbench/quickstart.md`, recording whether resulting state and lifecycle metadata appear within 2 seconds without a full-page reload.
