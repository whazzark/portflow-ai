# Requirements Checklist: Archive and Reactivate Customers
...
- [x] Historical migration captured the delivered capability named "Archive and Reactivate Customers".
