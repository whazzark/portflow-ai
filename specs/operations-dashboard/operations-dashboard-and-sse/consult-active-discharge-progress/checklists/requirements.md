# Requirements Checklist: Consult Active Discharge Progress
...
- [ ] Define the actor, scope, intended behavior, and observable acceptance criteria for "Consult Active Discharge Progress" before planning.
