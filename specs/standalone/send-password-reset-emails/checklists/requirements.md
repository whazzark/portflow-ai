# Requirements Checklist: Send password reset emails
...
- [ ] Define the actor, scope, intended behavior, and observable acceptance criteria for "Send password reset emails" before planning.
