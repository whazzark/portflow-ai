...
export interface ApiDefinition {
  ...
  discharges: {
    ...
    startCheck: typeof routes['discharges.start_check']
    start: typeof routes['discharges.start']
    productLots: {
    ...
    customerProductLots: {
      update: typeof routes['discharges.customer_product_lots.update']
    }
  }
  users: {
  ...
  warehouses: {
    ...
    reactivate: typeof routes['warehouses.reactivate']
  }
}
